...
const ReportsView = () => {
  ...
  const openEdit = (report) => {
    ...
    setEditForm({
      ...
      thrown_away_stock:    report.thrown_away_stock,
    });
      ...
      <html><head>
        ...
        <table>
          ...
          <tbody>
            ...
            <tr><td>Thrown Away Stock</td><td>${fmt(report.thrown_away_stock)} kg</td></tr>
          </tbody>
        </table>
          ...
          reports.map((report) => (
            <div className="report-card" key={report.report_id}>
              ...
              <ul className="report-card-details">
                ...
                <li>Thrown Away Stock: <strong>{fmt(report.thrown_away_stock)} kg</strong></li>
              </ul>
          ...
          <div className="rpt-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleEditSubmit} className="rpt-modal-form">
              {[
                ...
                { name: "thrown_away_stock",   label: "Thrown Away Stock (kg)" },
              ].map(({ name, label }) => (
